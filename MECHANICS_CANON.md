...
**C2 — Skill count is 18 or 19.**
`handoff eine` says "18 skills" and Phase 3 says "all 18 skills," but the enumerated list contains **19**:
Combat 5 + Dodge 2 + Hacking 3 + Stealth 2 + Medical 1 + Craft 4 + Social 2 = **19**.
→ Either one skill is meant to be cut, or the count is a typo. **Your decision.** (This doc treats it as 19 until told otherwise.)
